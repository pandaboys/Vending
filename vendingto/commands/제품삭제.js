...
function makeembed(title, des, color) {
    ...
    const mesd = new Discord.MessageEmbed() 
		...
		if (message.content.startsWith(prefix+"제품삭제")) { 
...
return;
            ...
            var nanne = message.content.substring(6);
            if(nanne.includes(" ")) return;
            if(hack[nanne]) {
                delete hack[nanne];
